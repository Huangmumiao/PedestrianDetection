      ...
      pieces: [
        {
          ...
          gte: props.data.TrendData[2][props.data.TrendData[2].length - 1],
          color: "red",
        },
        {
          // lte: props.data.TrendData[3][0],
          lte: props.data.TrendData[3][props.data.TrendData[3].length - 1],
          color: "red",
        },
        {
          // gte: props.data.TrendData[3][0],
          // lte: props.data.TrendData[2][0],
          gte: props.data.TrendData[3][props.data.TrendData[3].length - 1],
          lte: props.data.TrendData[2][props.data.TrendData[2].length - 1],
          color: props.color[0],
        },
      ],
    };
